...
<head>
    ...
    <script type="text/javascript" src="templates/CollapsibleLists.js"></script>
</head>
...
<table width="100%" border="0" bgcolor="#a8ddff" class="globaltable" cellspacing="0" cellpadding="0">
    ...
    <tr>
        <td colspan="3" align="right">
            <a href=# onClick="this.style.behavior='url(#default#homepage)'; this.setHomePage('http://www.somedomain.by/'); return false;">сделать стартовой</a>&nbsp;/&nbsp;
            <a rel="sidebar" onclick="window.external.AddFavorite(location.href,'ФИРМА'); return false;" href="http://www.somedomain.by/" title="ФИРМА">в избранное</a>
        </td>
    </tr>
            ...
            <table border="0" width="100%" cellspacing="5" cellpaddong="5">
                ...
                <tr>
                    ...
                    <td width="30%">
                        ...
                        <ul class="newsmenu">
                            <li><span class="date">2015-06-06</span><br/>
                                <a href="#">Новые поступления автомобилей</a></li>
                            <li><span class="date">2015-06-03</span><br/>
                                <a href="#">Новые поступления карбюраторов</a></li>
                            <li><span class="date">2015-05-27</span><br/>
                                <a href="#">Новые поступления глушителей для автомобилей Volkswagen</a></li>
                            <li><span class="date">2015-05-25</span><br/>
                                <a href="#">Скидки на всё к 1 мая</a></li>
                        </ul>
